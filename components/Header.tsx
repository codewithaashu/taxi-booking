...
const Header = () => {
  return (
    <div className="grid grid-cols-2 px-5 py-4 border-b-[1px] border-gray-100 shadow-sm">
        <div className="flex md:justify-between col-span-1 items-center">
        <div className="px-3">
            <Image src="/Go-Taxis-Logo.png" alt="Logo" width={60} height={60} className="w-full"/>     
        </div>
